...
declare global {
  ...
  const FanficLayout: typeof import('./src/composables/useFanficLayout')['FanficLayout']
  const FanficLayoutComponent: typeof import('./src/composables/useFanficLayout')['FanficLayoutComponent']
  const LAYOUTS: typeof import('./src/composables/useLayout')['LAYOUTS']
  ...
  const useCategoryStore: typeof import('./src/stores/loaders/category')['useCategoryStore']
  ...
  const useLayoutFactory: typeof import('./src/composables/useLayoutFactory')['useLayoutFactory']
  const useMeta: typeof import('vue-meta')['useMeta']
  const useModel: typeof import('vue')['useModel']
  const usePageStore: typeof import('./src/stores/page')['usePageStore']
  const usePostsStore: typeof import('./src/stores/loaders/posts')['usePostsStore']
  const useRoute: typeof import('vue-router')['useRoute']
  const useRouter: typeof import('vue-router')['useRouter']
  const useSlots: typeof import('vue')['useSlots']
  const useTemplateRef: typeof import('vue')['useTemplateRef']
  const validateCache: typeof import('./src/stores/loaders/helper')['validateCache']
